...
} from 'app/mock-api/apps/smart-agents/data';
import { cloneDeep } from 'lodash-es';

@Injectable({ providedIn: 'root' })
export class SmartAgentsMockApi {
    ...
    registerHandlers(): void {
        ...
        this._fuseMockApiService
            .onGet('api/apps/smart-agents/categories')
            .reply(() => {
        ...
        // @ Courses - GET
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService.onGet('api/apps/smart-agents/smartagents').reply(() => {
            // Clone the courses
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/smart-agents/smartagents/smartagent')
            .reply(({ request }) => {
